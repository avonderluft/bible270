...
check app/helpers/bible270/plan_helper.rb                    'def b270_comment_body'
...
check app/views/bible270/comments/_comment.html.erb          'b270_comment_body'
check app/views/bible270/comments/_editor.html.erb           'b270-mention-composer'
check lib/bible270/comment_formatter.rb                      'def link_mentions'
